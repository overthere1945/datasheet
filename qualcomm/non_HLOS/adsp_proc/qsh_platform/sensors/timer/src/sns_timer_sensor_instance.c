...
static sns_rc sns_timer_inst_notify_event(sns_sensor_instance *const this)
{
  UNUSED_VAR(this);
  // N/A
...
SNS_SECTION(".text.sns")
static sns_rc sns_timer_inst_init(sns_sensor_instance *const this,
...
SNS_SECTION(".text.sns")
static sns_rc sns_timer_inst_deinit(sns_sensor_instance *const this)
{
  UNUSED_VAR(this);
  // N/A
  return SNS_RC_SUCCESS;
...
const sns_sensor_instance_api sns_timer_sensor_instance_api SNS_SECTION(
