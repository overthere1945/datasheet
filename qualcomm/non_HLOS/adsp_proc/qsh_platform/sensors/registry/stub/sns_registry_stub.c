/*=============================================================================
  @file sns_registry_stub.c

  File reverse API wrappers for use by the Sensors Registry.
...
#ifndef _SNS_REGISTRY_STUB_H
#define _SNS_REGISTRY_STUB_H
                                     ...
                                     unsigned int al, void **ppbuf)
{
  ...
  if((_ALIGN_SIZE((uintptr_t)me->stackEnd, al) + size) <
     (uintptr_t)me->stack + me->nSize)
  {
...
#else
#endif
static const Parameter parameters[2] = {{SLIM_IFPTR32(0x8, 0x10),
                                        ...
                                        {SLIM_IFPTR32(0x8, 0x10),
                                         ...
                                         3,
                                         0}};
static const Parameter *const parameterArrays[2] = {(&(parameters[0])),
                                                    (&(parameters[1]))};
static const Method methods[1] = {
    {REMOTE_SCALARS_MAKEX(0, 0, 0x2, 0x1, 0x0, 0x0), 0x8, 0x0, 4, 2,
...
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(sns_registry_slim) = {
...
#ifndef _const_sns_registry_handle
#define _const_sns_registry_handle ((remote_handle)-1)
#endif //_const_sns_registry_handle

  static void _sns_registry_pls_dtor(void *data)
  {
    remote_handle *ph = (remote_handle *)data;
    if(_const_sns_registry_handle != *ph)
    {
      (void)__QAIC_REMOTE(remote_handle_close)(*ph);
      *ph = _const_sns_registry_handle;
    }
  }

  static int _sns_registry_pls_ctor(void *ctx, void *data)
  {
    remote_handle *ph = (remote_handle *)data;
    *ph = _const_sns_registry_handle;
...
#pragma weak HAP_pls_add_lookup
  ...
  __QAIC_STUB_EXPORT remote_handle _sns_registry_handle(void)
  {
    remote_handle *ph;
    if(adsp_pls_add_lookup)
    {
      if(0 == adsp_pls_add_lookup((uint32_t)_sns_registry_handle, 0,
                                  sizeof(*ph), _sns_registry_pls_ctor,
                                  "sns_registry", _sns_registry_pls_dtor,
                                  (void **)&ph))
      {
        return *ph;
      }
    ...
    {
      if(0 == HAP_pls_add_lookup((uint32_t)_sns_registry_handle, 0, sizeof(*ph),
                                 _sns_registry_pls_ctor, "sns_registry",
                                 _sns_registry_pls_dtor, (void **)&ph))
      {
        return *ph;
      }
      return (remote_handle)-1;
...
uint32_t _sns_registry_atomic_CompareAndExchange(uint32_t *volatile puDest,
                                                 uint32_t uExchange,
                                                 uint32_t uCompare);
...
__QAIC_STUB_EXPORT remote_handle _sns_registry_handle(void)
{
  static remote_handle handle = _const_sns_registry_handle;
  ...
  {
    remote_handle tmp;
    int nErr = _sns_registry_pls_ctor("sns_registry", (void *)&tmp);
    if(nErr)
    {
      return (remote_handle)-1;
    }
    if(((remote_handle)-1 != handle) ||
       ((remote_handle)-1 !=
        (remote_handle)_sns_registry_atomic_CompareAndExchange(
            (uint32_t *)&handle, (uint32_t)tmp, (uint32_t)-1)))
    {
      _sns_registry_pls_dtor(&tmp);
    }
    return handle;
  }
}
  ...
  __QAIC_STUB(sns_registry_skel_invoke)(uint32_t _sc,
                                        remote_arg *_pra) __QAIC_STUB_ATTRIBUTE
  {
    return __QAIC_REMOTE(remote_handle_invoke)(_sns_registry_handle(), _sc,
                                               _pra);
  }
...
extern "C"
{
  ...
  __QAIC_STUB_EXPORT int __QAIC_STUB(sns_registry_get_property)(
      const char *prop_name, char *prop_value,
      int prop_valueLen) __QAIC_STUB_ATTRIBUTE
  {
    uint32_t _mid = 0;
    return _stub_method(_sns_registry_handle(), _mid, (char **)&prop_name,
                        (char **)&prop_value, (uint32_t *)&prop_valueLen);
  }
#ifdef __cplusplus
}
#endif
#endif //_SNS_REGISTRY_STUB_H
